              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-ship"></i> Operasional & Shipping<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirops.php?page=voyageTracking">Voyage Tracking <br> <b style="color:#f5b042">(Coming Soon)</b></a></li>
                      <li><a href="dirops.php?page=vesselDatabase">Vessel Database</a></li>
                      <li><a href="dirops.php?page=stockBBM">Stock BBM Monitor <br> <b style="color:#f5b042">(Coming Soon)</b></a></li>
                  ...
                  <li><a><i class="fa fa-users"></i> Human Resources<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirops.php?page=dataKaryawan">Database Karyawan</a></li>
                      <li><a href="dirops.php?page=crew">Database Crew</a></li>
                      <li><a href="dirops.php?page=onDuty">On Duty Karyawan</a></li>
                      <li><a href="dirops.php?page=slipGaji">Slip Gaji</a></li>
                      <li><a href="dirops.php?page=cutiKaryawan">Cuti Karyawan</a></li>
                  ...
                  <li><a><i class="fa fa-gear"></i> Setting<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirops.php?page=profile">Profile</a></li>
          ...
          <?php
                    if(isset($_GET['page'])){
                        ...
                        switch ($page) {
                            ...
                            case "loanPanjar":
                              include "page/02operasion_dan_shipping/pengajuan_ppu/loan-panjar/approve/app3/app3.php";
                              break;
                        ...
                        switch ($form) {
                            ...
                            case "reviseExpenses":
                              include "page/02operasion_dan_shipping/pengajuan_ppu/expenses/revise/revise3/revise3.php";
                              break;

                            case "rejectExpenses":
                              include "page/02operasion_dan_shipping/pengajuan_ppu/expenses/reject/reject3.php";
                              break;
                            ...
                            case "approvePpu":
                              include "page/02operasion_dan_shipping/pengajuan_ppu/loan-panjar/approve/app3/konfirmasiapp3.php";
                              break;

                            case "revisePpu":
                              include "page/02operasion_dan_shipping/pengajuan_ppu/loan-panjar/revise/revise3/revise3.php";
                              break;

                            case "rejectPpu":
                              include "page/02operasion_dan_shipping/pengajuan_ppu/loan-panjar/reject/reject3.php";
                              break;
