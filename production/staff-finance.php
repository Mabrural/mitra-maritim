        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="staff-finance.php?page=dashboard" class="site_title"><i class="fa fa-anchor"></i> <span>Mitra Maritim, M </span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="staff-finance.php?page=dashboard">Dashboard</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-bar-chart"></i> Sales & Marketing<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="staff-finance.php?page=salesPlan">Sales Plan</a></li>
                      <li><a href="staff-finance.php?page=RAB">RAB</a></li>
                  ...
                  <li><a><i class="fa fa-shopping-cart"></i> Purchasing<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="staff-finance.php?page=inventarisAsset">Inventaris & Asset Armada</a></li>
                      <li><a href="staff-finance.php?page=pengajuanPPU">Pengajuan PPU</a></li>
                      <li><a href="staff-finance.php?page=dataBarang">Data Barang/Sparepart</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-users"></i> Human Resources<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="staff-finance.php?page=dataKaryawan">Database Karyawan</a></li>
                      <li><a href="staff-finance.php?page=crew">Database Crew</a></li>
                      <li><a href="staff-finance.php?page=onDuty">On Duty Karyawan</a></li>
                      <li><a href="staff-finance.php?page=slipGaji">Slip Gaji</a></li>
                      <li><a href="staff-finance.php?page=cutiKaryawan">Cuti Karyawan</a></li>
