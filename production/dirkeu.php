                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirkeu.php?page=dashboard">Dashboard</a></li>
                  ...
                  <li><a><i class="fa fa-bar-chart"></i> Sales & Marketing<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="dirkeu.php?page=salesPlan">Sales Plan</a></li>
                      <li><a href="dirkeu.php?page=RAB">RAB</a></li>
                  ...
                  <li><a><i class="fa fa-shopping-cart"></i> Purchasing<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirkeu.php?page=inventarisAsset">Inventaris & Asset Armada</a></li>
                      <li><a href="dirkeu.php?page=pengajuanPPU">Pengajuan PPU</a></li>
                      <li><a href="dirkeu.php?page=dataBarang">Data Barang/Sparepart</a></li>
                    </ul>
                  </li>
          ...
          <?php
                    if(isset($_GET['page'])){
                        ...
                        switch ($page) {
                            ...
                            case 'salesPlan':
                                include "page/01sales_dan_marketing/sales_plan/approve_sales/app3/app3.php";
                                break;
                            ...
                            case 'inventarisAsset':
                              ...
                              case "RAB":
                                include "page/01sales_dan_marketing/rab/approve_rab/app3/app3.php";
                                break;
                        ...
                        switch ($form) {
                          ...
                          case "approveExpenses":
                            include "page/02operasion_dan_shipping/pengajuan_ppu/expenses/approve/app5/konfirmasiapp5.php";
                            break;

                          case "reviseExpenses":
                            include "page/02operasion_dan_shipping/pengajuan_ppu/expenses/revise/revise5/revise5.php";
                            break;

                          case "rejectExpenses":
                            include "page/02operasion_dan_shipping/pengajuan_ppu/expenses/reject/reject5.php";
                            break;
                          ...
                          case "lihatUraian":
                            ...
                            case "approveSales":
                                include "page/01sales_dan_marketing/sales_plan/approve_sales/app3/konfirmasiapp3.php";
                                break;

                            case "reviseSales":
                                include "page/01sales_dan_marketing/sales_plan/revise_sales/revise3/revise3.php";
                                break;

                            case "rejectSales":
                                include "page/01sales_dan_marketing/sales_plan/reject_sales/reject3.php";
                                break;
                            ...
                            case "approveRab":
                              include "page/01sales_dan_marketing/rab/approve_rab/app3/konfirmasiapp3.php";
                              break;

                            case "reviseRab":
                              include "page/01sales_dan_marketing/rab/revise_rab/revise3/revise3.php";
                              break;

                            case "rejectRab":
                              include "page/01sales_dan_marketing/rab/reject_rab/reject3.php";
                              break;
