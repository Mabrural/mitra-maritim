        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="sales.php" class="site_title"><i class="fa fa-anchor"></i> <span>Mitra Maritim, M </span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirut.php?page=dashboard">Dashboard</a></li>
                  ...
                  <li><a><i class="fa fa-bar-chart"></i> Sales & Marketing<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="dirut.php?page=salesPlan">Sales Plan</a></li>
                      <li><a href="dirut.php?page=RAB">RAB</a></li>
                      <li><a href="dirut.php?page=pengajuanPPU">Pengajuan PPU</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-ship"></i> Operasional & Shipping<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirut.php?page=voyageTracking">Voyage Tracking <br> <b style="color:#f5b042">(Coming Soon)</b></a></li>
                      <li><a href="dirut.php?page=vesselDatabase">Vessel Database</a></li>
                      <li><a href="dirut.php?page=stockBBM">Stock BBM Monitor <br> <b style="color:#f5b042">(Coming Soon)</b></a></li>
                      <li><a href="dirut.php?page=monitoringSertifikat">Monitoring Sertifikat & Legalitas</a></li>
                      <li><a href="dirut.php?page=pengajuanPPU">Pengajuan PPU</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-shopping-cart"></i> Purchasing<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirut.php?page=inventarisAsset">Inventaris & Asset Armada</a></li>
                      <li><a href="dirut.php?page=pengajuanPPU">Pengajuan PPU</a></li>
                      <li><a href="dirut.php?page=dataBarang">Data Barang/Sparepart</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-credit-card"></i> Finance & Accounting<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirut.php?page=dataBarang">PPU & BPU</a></li>
                      <li><a href="dirut.php?page=actualRAB">RAB/Actual RAB (Jurnal Umum) <br> <b style="color:#f5b042">(Coming Soon)</b></a></li>
                      <li><a href="dirut.php?page=omset">Penjualan (Omset) <br> <b style="color:#f5b042">(Coming Soon)</b></a></li>
                      <li><a href="dirut.php?page=labaRugi">Laba & Rugi <br> <b style="color:#f5b042">(Coming Soon)</b></a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-users"></i> Human Resources<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirut.php?page=dataKaryawan">Database Karyawan</a></li>
                      <li><a href="dirut.php?page=crew">Database Crew</a></li>
                      <li><a href="dirut.php?page=onDuty">On Duty Karyawan</a></li>
                      <li><a href="dirut.php?page=slipGaji">Slip Gaji</a></li>
                      <li><a href="dirut.php?page=cutiKaryawan">Cuti Karyawan</a></li>
                  ...
                  <li><a><i class="fa fa-gear"></i> Setting<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirut.php?page=profile">Profile</a></li>
          ...
          <?php
                    if(isset($_GET['page'])){
                        ...
                        switch ($page) {
                            ...
                            case 'salesPlan':
                                include "page/01sales_dan_marketing/sales_plan/approve_sales/app2/app2.php";
                                break;
                            ...
                            case 'inventarisAsset':
                              ...
                              case "RAB":
                                include "page/01sales_dan_marketing/rab/approve_rab/app2/app2.php";
                                break;
                        ...
                        switch ($form) {
                          ...
                          case "rejectExpenses":
                            ...
                            case "approvePpu":
                              include "page/02operasion_dan_shipping/pengajuan_ppu/loan-panjar/approve/app4/konfirmasiapp4.php";
                              break;

                            case "revisePpu":
                              include "page/02operasion_dan_shipping/pengajuan_ppu/loan-panjar/revise/revise4/revise4.php";
                              break;

                            case "rejectPpu":
                              include "page/02operasion_dan_shipping/pengajuan_ppu/loan-panjar/reject/reject4.php";
                              break;
                            ...
                            case "approveSales":
                                include "page/01sales_dan_marketing/sales_plan/approve_sales/app2/konfirmasiapp2.php";
                                break;

                            case "reviseSales":
                                include "page/01sales_dan_marketing/sales_plan/revise_sales/revise2/revise2.php";
                                break;

                            case "rejectSales":
                                include "page/01sales_dan_marketing/sales_plan/reject_sales/reject2.php";
                                break;
                            ...
                            case "approveRab":
                              include "page/01sales_dan_marketing/rab/approve_rab/app2/konfirmasiapp2.php";
                              break;

                            case "reviseRab":
                              include "page/01sales_dan_marketing/rab/revise_rab/revise2/revise2.php";
                              break;
