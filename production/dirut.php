              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-ship"></i> Operasional & Shipping<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirut.php?page=voyageTracking">Voyage Tracking</a></li>
                      <li><a href="dirut.php?page=vesselDatabase">Vessel Database</a></li>
                      <li><a href="dirut.php?page=stockBBM">Stock BBM Monitor</a></li>
                  ...
                  <li><a><i class="fa fa-credit-card"></i> Finance & Accounting<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="dirut.php?page=dataBarang">RAB/Actual RAB (Jurnal Umum)</a></li>
                      <li><a href="dirut.php?page=dataBarang">Penjualan (Omset)</a></li>
                      <li><a href="dirut.php?page=dataBarang">Laba & Rugi</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-users"></i> Human Resources<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirut.php?page=reqCuti">Database Karyawan</a></li>
                      <li><a href="dirut.php?page=reqCuti">Database Crew</a></li>
                      <li><a href="dirut.php?page=reqCuti">On Duty Karyawan</a></li>
                      <li><a href="dirut.php?page=reqCuti">Slip Gaji</a></li>
                      <li><a href="dirut.php?page=reqCuti">Form Cuti</a></li>
                      <li><a href="dirut.php?page=historyCuti">History Cuti</a></li>
                  ...
                  <li><a><i class="fa fa-gear"></i> Setting<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirut.php?page=dataBarang">Inventaris & Asset Armada</a></li>
                      <li><a href="dirut.php?page=dataBarang">Sales Plan</a></li>
                      <li><a href="dirut.php?page=dataBarang">RAB</a></li>
                      <li><a href="dirut.php?page=dataBarang">Pengajuan PPU</a></li>
                    </ul>
                  </li>
