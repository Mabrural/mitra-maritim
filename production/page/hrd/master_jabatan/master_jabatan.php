...
?>
    <div class="x_panel">
      <div class="x_title">
        <h2>Master Jabatan<small></small></h2><br>
        <form action="laporan/cetak_inventaris.php" method="get">
          ...
          <a href="?form=tambahJabatan" class="btn btn-primary btn-sm"><i class="fa fa-plus fa-sm"></i> Tambah Jabatan</a>
          ...
          <a href="?page=masterJabatan" class="btn btn-warning btn-sm btn disabled" autofocus="on"><i class="fa fa-user"></i> Master Jabatan</a>
          ...
          <table id="example" class="display" style="width:100%">
            ...
            <tbody>
              <tr class="even pointer">
                ...
                <td class=" last"><a href="?form=ubahJabatan&id_jabatan=<?= $data["id_jabatan"]; ?>" class="btn btn-info btn-sm">Ubah </a> | <a href="?form=hapusJabatan&id_jabatan=<?= $data["id_jabatan"]; ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger btn-sm">Hapus </a>
                </td>
              </tr>
