...
?>
    <div class="x_panel">
      <div class="x_title">
        ...
        <a href="?page=approvedCuti" class="btn btn-success btn-sm btn disabled"><i class="fa fa-check"></i> Approved</a>
            ...
            <tbody>
              <tr class="even pointer">
                <?php 
                  ...
                  $query = "SELECT * FROM req_cuti JOIN kategori_cuti ON kategori_cuti.id_kategori_cuti=req_cuti.id_kategori_cuti JOIN karyawan ON karyawan.id_emp=req_cuti.id_emp JOIN user ON user.id_emp=karyawan.id_emp WHERE user.id_user=$id_user AND req_cuti.status_cuti='Approved'";
                ...
                <td class=" last">
                    <?php if ($data['status_cuti'] == 'Pending') : ?>
