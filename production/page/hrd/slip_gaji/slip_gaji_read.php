...
?>
    <div class="x_panel">
      <div class="x_title">
        <h2>Data Slip Gaji <small></small></h2>
              ...
              <tr class="even pointer">
              	<?php 
                    ...
                    if (!empty($_GET['periode_awal']) && isset($_GET['periode_akhir'])) {
              		...
              		// $query = "SELECT * FROM slip_gaji JOIN karyawan ON karyawan.id_emp=slip_gaji.id_emp JOIN jabatan ON jabatan.id_jabatan=karyawan.id_jabatan JOIN user ON user.id_emp=karyawan.id_emp WHERE user.id_user=$id_user";
