          ...
          <table id="example" class="display" style="width:100%">
            ...
            <tbody>
              <tr class="even pointer">
              	<?php 
              		$no = 1;
              		$query = "SELECT * FROM absen JOIN karyawan ON karyawan.id_emp=absen.id_emp JOIN lantai ON lantai.id_lantai=absen.id_lantai JOIN divisi ON divisi.id_divisi=karyawan.id_divisi JOIN jabatan ON jabatan.id_jabatan=karyawan.id_jabatan ORDER BY absen.id_absen DESC";
