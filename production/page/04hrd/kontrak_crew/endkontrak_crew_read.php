...
?>
    <div class="x_panel">
      <div class="x_title">
        <h2>Crew End Contract<small></small></h2>
          ...
          <table id="example" class="display" style="width:100%">
            ...
            <tbody>
              <tr class="even pointer">
              	<?php 
              		$no = 1;
              		$query = "SELECT * FROM kontrak_crew JOIN crew ON crew.id_crew=kontrak_crew.id_crew JOIN vessel ON vessel.id_vessel=crew.id_vessel JOIN status_crew ON status_crew.idstatus_crew=kontrak_crew.idstatus_crew WHERE kontrak_crew.idstatus_crew=2 ORDER BY kontrak_crew.id_kontrakcrew DESC";
