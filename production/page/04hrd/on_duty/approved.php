...
?>
    <div class="x_panel">
      <div class="x_title">
        ...
        <a href="?page=onDuty" class="btn btn-warning btn-sm"><i class="fa fa-clock-o"></i> Pending</a>
        <a href="?page=approved" class="btn btn-success btn-sm  btn disabled"><i class="fa fa-check"></i> Approved</a>
          ...
          <table id="example" class="display" style="width:100%">
            ...
            <tbody>
              <tr class="even pointer">
              	<?php 
              		$no = 1;
              		$query = "SELECT * FROM on_duty JOIN karyawan ON karyawan.id_emp=on_duty.id_emp JOIN user ON user.id_emp=karyawan.id_emp WHERE on_duty.status_duty='Approved' AND user.id_user=$id_user ORDER BY id_duty DESC";
                ...
                <td class=" last">
                    <?php
                        if ($data['status_duty'] !== 'Menunggu Persetujuan') {
