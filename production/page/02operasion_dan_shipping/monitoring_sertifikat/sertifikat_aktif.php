...
?>
    <div class="x_panel">
      <div class="x_title">
        <h2>Sertifikat Aktif<small></small></h2>
          ...
          <table id="example" class="display" style="width:100%">
            ...
            <tbody>
              <tr class="even pointer">
              	<?php 
              		$no = 1;
              		$query = "SELECT * FROM sertifikat_kapal JOIN vessel ON vessel.id_vessel=sertifikat_kapal.id_vessel WHERE sertifikat_kapal.status_cert='Aktif'";
