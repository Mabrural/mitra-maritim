...
?>
    <div class="x_panel">
      <div class="x_title">
        ...
        <a href="?form=tambahBpuExpenses" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> New BPU Expenses</a>       
          ...
          <table id="example" class="display" style="width:100%">
            ...
            <tbody>
              <tr class="even pointer">
              	<?php 
              		$no = 1;
              		$query = "SELECT * FROM bpu_expenses JOIN expenses ON expenses.id_expenses=bpu_expenses.id_expenses JOIN karyawan ON karyawan.id_emp=bpu_expenses.penerima_exp";
