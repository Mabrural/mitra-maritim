...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2024 at 11:36 AM
...
-- Database: `json`
--
CREATE DATABASE IF NOT EXISTS `json` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `json`;
...
(1, '4342311001', 'Muhammad Mabrur Al Mutaqi', 'Teknik Informatika'),
(2, '4342311002', 'Ahmad Azka Salam', 'Teknik Informatika'),
(3, '4342311003', 'Shah Rizal', 'Teknik Informatika'),
(4, '4342311004', 'Rizqi Fahila', 'Teknik Informatika');
...
(21, 'BRG001', 'Laptop ASUS ROG Strix 15,6 inch', 17000000),
(22, 'BRG002', 'Keyboard Logitech', 150000),
(23, 'BRG003', 'Mouse Macro ', 300000),
(24, 'brg10', 'kertas 1 rim', 50000),
(28, 'BRG6', 'Kursi Kantor', 120000),
(29, 'BRG001', 'Kursi Panjang', 120000),
(32, 'BRG001', 'Kursi', 120000),
(33, 'BRG6', 'Mousepad', 25000);
...
('root', '[{\"db\":\"sistem\",\"table\":\"port\"},{\"db\":\"sistem\",\"table\":\"tbl\"},{\"db\":\"sistem\",\"table\":\"req_cuti\"},{\"db\":\"sistem\",\"table\":\"karyawan\"},{\"db\":\"sistem\",\"table\":\"ijazah\"},{\"db\":\"sistem\",\"table\":\"user\"},{\"db\":\"sistem\",\"table\":\"jabatan\"},{\"db\":\"sistem\",\"table\":\"divisi\"},{\"db\":\"sistem\",\"table\":\"bank\"},{\"db\":\"sistem\",\"table\":\"sales_plan\"}]');
...
('root', '2024-02-21 07:53:01', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `sistem`
--
CREATE DATABASE IF NOT EXISTS `sistem` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sistem`;
